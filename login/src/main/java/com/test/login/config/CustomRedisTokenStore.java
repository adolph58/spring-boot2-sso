...
/**
 * 最新版中 RedisTokenStore 的 set 已经被弃用了，这里重写一个，
 * 代码和RedisTokenStore一样，只是把所有conn.set(…)都换成conn..stringCommands().set(…)，
 *
 * spring-security-oauth2 - 2.2.2 版本之前 redis 操作有问题
 * Spring Boot 2.1.0 或 Spring Cloud Greenwich 之前需要自己重写
 * Spring Boot 2.1.0 或 Spring Cloud Greenwich 之后问题已修复，直接用 RedisTokenStore 即可
 */
